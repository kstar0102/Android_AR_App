...
//        });
    ...
    public void onSessionConfiguration(Session session, Config config) {
        ...
        Bitmap scubaImage = BitmapFactory.decodeResource(getResources(), R.drawable.scuba);
        // Every image has to have its own unique String identifier
        database.addImage("matrix", matrixImage);
        database.addImage("rabbit", rabbitImage);
        database.addImage("scuba", scubaImage);
    ...
    public void onAugmentedImageTrackingUpdate(AugmentedImage augmentedImage) {
        ...
        if (augmentedImage.getTrackingState() == TrackingState.TRACKING
            ...
            if (!matrixDetected && augmentedImage.getName().equals("scuba")) {
                matrixDetected = true;
                Toast.makeText(this, "scuba tag detected", Toast.LENGTH_LONG).show();
